...
$('.sendbutton').click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var jsonObject, responseFromPost;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        //Imaginary input from user
        jsonObject = (0, _WeatherData.default)("2019-07-30T10:07:00.000Z", "temperature", 21, "C", "Aarhus");
        _context.next = 3;
        return postData(jsonObject);
      case 3:
        responseFromPost = _context.sent;
...
$('.forecastbtn').click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var thebuttonclicked, response, city, max, min, avg, precipition, last;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 20:
        precipition = _context2.sent;
        (0, _displaystuff.displayTotalPrecipitation)(precipition);
        _context2.next = 24;
        return getLasestMeasurements(city);
      case 24:
        last = _context2.sent;
        (0, _displaystuff.displayLatestTemperature)(last.latestTemperature);
        (0, _displaystuff.displayLatestPrecipitation)(last.latestPrecipitation);
        (0, _displaystuff.displayLatestWindSpeed)(last.latestWindSpeed);
      case 28:
      case "end":
...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(city) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          url = "http://localhost:8080/data/".concat(city);
          _context3.prev = 1;
          _context3.next = 4;
          return fetch(url);
        case 4:
...
function _getForecast() {
  _getForecast = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(city) {
    var url, response;
...
function _handleForecasts() {
  _handleForecasts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(city) {
    var temps, precipitations, windSpeeds, cloudCoverage, resp;
        ...
        case 2:
          ...
          for (x in weatherData) {
            ...
            if (dataObj.type == "temperature") {
              tmp = (0, _Temperature.default)(dataObj.time, dataObj.place, dataObj.to, dataObj.type, dataObj.unit);
              tmp.convertToC();
              to = tmp.getValue();
          ...
          return _context6.abrupt("return", max);
        case 6:
        case "end":
...
function _getMinTemp() {
  _getMinTemp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(city) {
    var weatherData, min, x, dataObj, tmp, from;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          return getForecast(city);
        case 2:
          weatherData = _context7.sent;
          min = undefined;
          for (x in weatherData) {
            dataObj = weatherData[x];
            if (dataObj.type == "temperature") {
              tmp = (0, _Temperature.default)(dataObj.time, dataObj.place, dataObj.from, dataObj.type, dataObj.unit);
              tmp.convertToC();
              from = tmp.getValue();
          ...
          return _context7.abrupt("return", min);
        case 6:
        case "end":
...
function getLasestMeasurements(_x6) {
  return _getLasestMeasurements.apply(this, arguments);
}
function _getLasestMeasurements() {
  _getLasestMeasurements = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(city) {
    var weatherData, latestTemperature, latestPrecipitation, latestWindSpeed, i, dataObj, temp, precip, wind;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          return getData(city);
        case 2:
          weatherData = _context8.sent;
          for (i in weatherData) {
            dataObj = weatherData[i];
            if (dataObj.type === "temperature") {
              temp = new _Temperature.default(dataObj.time, dataObj.place, dataObj.value, dataObj.unit);
              temp.convertToC();
            ...
            if (dataObj.type === "precipitation") {
              precip = new _Precipitation.default(dataObj.time, dataObj.place, dataObj.value, dataObj.unit);
              precip.convertToMM();
            ...
            if (dataObj.type === "wind speed") {
              wind = new _Wind.default(dataObj.time, dataObj.place, dataObj.value, dataObj.unit);
              wind.convertToMph();
          ...
          return _context8.abrupt("return", {
            ...
            latestPrecipitation: latestPrecipitation,
...
function getTotalPrecipitation(_x7) {
  return _getTotalPrecipitation.apply(this, arguments);
}
function _getTotalPrecipitation() {
  _getTotalPrecipitation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(city) {
    var wd, _totalprecipitation, i, dataObj, precipitationtemp, test;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 2:
          wd = _context9.sent;
          _totalprecipitation = 0;
          for (i in wd) {
            dataObj = wd[i];
            if (dataObj.type == "precipitation") {
              precipitationtemp = new _Precipitation.default(dataObj.time, dataObj.place, dataObj.value, dataObj.unit);
              precipitationtemp.convertToMM();
              test = precipitationtemp.getValue();
              _totalprecipitation += test;
            }
          }
          console.log("Total precipitation for the last day ", _totalprecipitation);
          return _context9.abrupt("return", _totalprecipitation);
        case 7:
        case "end":
...
function getAverageWindSpeed(_x8) {
  return _getAverageWindSpeed.apply(this, arguments);
}
function _getAverageWindSpeed() {
  _getAverageWindSpeed = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(city) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          return getData(city);
        case 2:
          weatherData1 = _context10.sent;
          _totalWindSpeed = 0;
          count = 0;
          for (i in weatherData1) {
            dataObj = weatherData1[i];
            if (dataObj.type == "wind speed") {
              windtemp = new _Wind.default(dataObj.time, dataObj.place, dataObj.value, dataObj.unit);
              windtemp.convertToMph();
              test = windtemp.getValue();
              _totalWindSpeed += test;
              count++;
            }
          }
          _averageWindSpeed = _totalWindSpeed / count; //console.log("Avg ", _averageWindSpeed);
          return _context10.abrupt("return", _averageWindSpeed);
        case 8:
        case "end":
...
function _postData() {
  _postData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(jsonObject) {
    var url, jsonObject2, jsonString, response;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          url = 'http://localhost:8080/data'; //Bad method to covert to JSON, but couldnt make JSON.Stringfy work
          jsonObject2 = {
